      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form-horizontal" id="frmData" method="post" action="{{ url('upah-jenis-barang/update').'/'.$jenis_upah->id }}" autocomplete="off">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="{{  $jenis_upah->nama  }}">
                  </div>
                </div>
                <div class="form-group">
                  <label for="upah" class="col-sm-2 control-label">Upah *</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="upah" id="upah" placeholder="upah" value="{{ old('upah') !==null ? : $jenis_upah->upah  }}">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
