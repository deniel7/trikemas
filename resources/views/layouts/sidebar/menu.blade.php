        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li {{ \Request::segment(1) == 'example' ? 'class="active"' : '' }}><a href="{{ url('/item') }}">Karyawan Tetap / Kontrak</a></li>
              <li {{ \Request::segment(1) == 'example' ? 'class="active"' : '' }}><a href="{{ url('/item') }}">Karyawan Lepas / Harian</a></li>
            </ul>
          </li>
