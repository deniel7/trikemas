...
@section('content')
    ...
    <section class="content-header">
      <h1>
        Laporan Absensi Karyawan Packing
        <small>&nbsp;</small>
      </h1>
        
      <ol class="breadcrumb">
        <li><a href="{{ url('/') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> Laporan Absensi Karyawan Packing</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form-horizontal" id="frmData" method="post" action="{{ url('/report/absensi-karyawan-harian/preview') }}" autocomplete="off">
    ...
    reportAbsensiKaryawanPackingModule.init();
    });
    </script>
