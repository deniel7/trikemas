...
var validationDetail = (function() {
    ...
    var _applyValidation = function() {
        ...
        .on('success.form.fv', function(e) {
            ...
            var id = $("#id").val();
            var dataString = "tanggal_bayar=" + $("#tanggal_bayar").val() + "&discount=" + $("#discount").val() + "&jumlah_bayar=" + $("#jumlah_bayar").val() + "&keterangan=" + $("#keterangan").val();
    ...
    var _applyDatatable = function() {
        ...
        table = $('#list').DataTable({
            ...
            'columns': [
                ...
                {data: 'harga_angkutan', name: 'harga_angkutan', className: "text-right"},
                {data: 'diskon_bayar_angkutan', name: 'diskon_bayar_angkutan', className: "text-right"},
                {data: 'jumlah_bayar_angkutan', name: 'jumlah_bayar_angkutan', className: "text-right"},
                {data: 'status_bayar_angkutan', name: 'status_bayar_angkutan', orderable: false, searchable: false},
                {data: 'tanggal_bayar_angkutan', name: 'tanggal_bayar_angkutan'},
                {data: 'keterangan_bayar_angkutan', name: 'keterangan_bayar_angkutan'},
